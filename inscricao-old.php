                         ...
                         <div class="box box-header">
                            ...
                            <div class="row margin">
                                ...
                                <div class="form-group col-lg-3 col-md-3" style="float: left; margin-left: -17px;">
                                  ...
                                  <select id="ensino" onchange="ChangeCarList()"> 
                                    ...
                                    <select name="seriefm" id="seriefm"onchange="ChangeSerieList()" >
                                        <option value="">serie</option> 
                                          
                                    </select> 
                                    <select id="idadefm">Idade</select> 
                                    
                                      

                                <script>
                                    var texto = $('#seriefm :selected').text();
                                var carsAndModels = {};
                                var resultado= "";
                                var grau_escolaridade = "";
                                carsAndModels['fundamental'] = ['6º', '7º', '8º', '9º'];
                                carsAndModels['medio'] = ['1º', '2º', '3º'];
                                carsAndModels['6º'] = ['10', '11', '12','13'];
                                carsAndModels['idadem'] = ['15', '16', '17','18'];
                                ...
                                function ChangeCarList() {
                                    ...
                                    var serieList = document.getElementById("seriefm");
                                    var idadeList = document.getElementById("idadefm");
                                    var selCar = ensinoList.options[ensinoList.selectedIndex].value;
                                    var idade = ensinoList.options[ensinoList.selectedIndex].value;
                                         //alert(selCar) mostra fundamental ou médio;
                                         grau_escolaridade =  selCar;
...
//                                     alert(cars);
                                     ...
                                     if (texto == '6º') {
                                           var idade = carsAndModels['6º'];
                                    } if (texto == '7º') {
                                      var idade = carsAndModels['7º'];
                                    }
                                  
                                    
                                        
                                         //as series medio 1,2,3 e fundamental 6,7,8,9
                                    if (cars) {
                                        var i;
                                        
                                        if (selCar=='fundamental') {
                                        ...
                                        for (i = 0; i < idade.length; i++) {
                                            var idadeLista = new Option(idade[i], i);
                                            idadeList.options.add(idadeLista);
                                 ...
                                 function ChangeSerieList() {
                                     //alert(idadefm);
                                    idadeList = document.getElementById("idadefm");
                                    var serieList = document.getElementById("seriefm");
                                    
                                    var valor = $('#seriefm').val();
                                   var texto = $('#seriefm :selected').text();
                                   var idadeList = texto;
                                   alert(idadeList);
                                     var seriePessoa = idadeList.options[idadeList.selectedIndex].value;
                                     alert(seriePessoa);
                                        while (idadeList.options.length) {
                                       // alert(serieList.options.length); muda a serie
                                        idadeList.remove(0);
                                    }
                                    
                                    var idadeLimite = carsAndModels[idadeList];
                                    ...
                                    if (idadeLimite) {
                                        ...
                                        for (i = 0; i < idadeLimite.length; i++) {
                                            
                                            var limite = new Option(idadeLimite[i], i);
                                            idadeList.options.add(limite);
                                           
                                        }
                                        
                                    }
                                     if(grau_escolaridade=='fundamental'){
