...
<head>
    ...
    <META http-equiv="refresh" content="10;URL=http://www.sereprf.intraer">  
    ...
    <div class="container" style="padding: 10px; border-width:10px; border-style:dashed; border-color:#D2B48C; border-radius: 10px;">
             <div class="col-lg-12 col-md-12">
					...
					<h1 class="">Inscrição para sorteio de vagas para o Colégio Militar do Recife <br> 
		                		<span style="font-size: 17px;font-style: italic;">SEREP-RF - Serviço de Recrutamento e Preparo de Pessoal da Aernáutica de Recife</span> 
	...
	<div class="col-lg-12 col-md-12"> <!-- box de separação entre boxes -->
                <div class="box box-default">
                    <div class="box-header">
                        <h5 class="box-title"> <p style="text-align: center; margin-left: 50%;">	- DADOS ENVIADO COM SUCESSO!
				</p></h5>
                    </div><!-- /.box-header -->
		</div>
	</div>
