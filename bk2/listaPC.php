...
<meta charset="UTF-8" />
		...
		<title>Lista de controle de PC</title>
...
<div style="padding: 3px;">
    <a target="_blanck" href="inclusaoPC.php"><button type="submit" class="btn btn-info" >CADASTRAR CLIENTE</button></a></div>
<br><br>
	...
	<table border="1"  style="width: 90%;">
		...
		<div class="container">	
			<!-- Codrops top bar -->
                        ...
                        <br><br>
                        <div>
                            <h2 align="center">STATUS de situação cadastrais</h2>
                        </div>
                        <br>
