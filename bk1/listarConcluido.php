    ...
    <div align="center">
		...
		<div class="container">	
			...
			<!-- Codrops top bar -->
                        ...
                        <div>
                            <h3 align="center">LISTA DE DEFERIDOS</h3>
                        </div>
                       </div> 
                        <table id='tabela2'colspan="9" border='1'width="90%" style="padding: 10px;">
	<thead>
		...
		<th align="center" style='width: 10%;color : black'><div align="center"> NOME DO MILITAR </div></th>
                <th align="center" style='width: 10%;color : black'><div align="center"> SARAM </div></th>
...
?>
        <tr align="center" style="margin-top: 10px;">
	 	...
	 	<td align="center" style="color : black"><?php echo $linha1['nome_militar']?></td>
                <td align="center" style="color : black"><?php echo $linha1['saram']?></td>
...
<!--                <td>
				...
				<button class="btn btn-info  btn-danger-block" type="submit">VOLTAR PARA LISTA </button>
                       ...
                       <a href="index.php">&emsp;&emsp;
				<button class="btn btn-info  btn-danger-block" type="submit">FORMULÁRIO</button>
			</a>
                      <br>
