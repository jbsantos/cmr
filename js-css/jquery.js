...
TableTools.BUTTONS = {
	"csv": $.extend( {}, TableTools.buttonBase, {
		...
		"sButtonText": "CSV",
		"sToolTip": "Clique para gerar CSV",
		"sFieldBoundary": '"',
		"sFieldSeperator": ",",
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sToolTip": "Clique para gerar XLS",
		"sButtonText": "Excel",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"sToolTip": "Clique para copiar a tabela de informacoes",
		"sButtonText": "Copiar",
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		},
	...
	"pdf": $.extend( {}, TableTools.buttonBase, {
		...
		"sToolTip": "Clique para gerar PDF",
		"sPdfSize": "A4",
		"sPdfMessage": "",
		"fnClick": function( nButton, oConfig, flash ) {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		...
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Clique para alterar para modo de impressao",
 ...
 */
TableTools.DEFAULTS = {
//public/js/plugins/datatables/copy_csv_xls_pdf.swf
	"sSwfPath":        "", 
	"sRowSelect":      "none",
	"sRowSelector":    "tr",
	"sSelectedClass":  null,
	...
	"aButtons": [
				{
					"sExtends":    "collection",
					"sButtonText": "Exportar Dados",
					"aButtons":    [ "copy", "csv", "xls", {
                                                                                "sExtends": "pdf",
                                                                                "sPdfOrientation": "landscape",
                                                                                "sPdfMessage": "Dados Exportados"
                                                                               }, 
                                                        "print" ]
				}
			],
