        ...
        if ($resultado){
            while ($linha = mysql_fetch_array($resultado)) {
                ...
                $dadosDoComprovante[3] = $linha['bol'];
                 ...
                 $dadosDoComprovante[5] = $linha['nascimento']; 
 		...
 		$apresentacao= $linha['bol_local_a'];
		$transferencia= $linha['bol_local'];
		 $localidade = $linha['localidade'];
		 $amparo = $linha['amparo'];
		 $emailP = $linha['email_p'];
 		$email = $linha['email'];
		 $saram = $linha['saram'];
                $dadosDoComprovante[13] = $linha['grau'];
                 $dadosDoComprovante[14] = $linha['ensino'];
                  $dadosDoComprovante[12] = $linha['data2']; 
        ...
        $html = "
			 ...
			 <script src='bootstrap/js/bootstrap.min.js'></script>
                    ...
                    <h5  align='center'>MINISTÉRIO DA DEFESA<br>COMANDO DA AERONÁUTICA <br> SERVIÇO DE RECRUTAMENTO E PREPARO DE PESSOAL DA AERONÁUTICA DE RECIFE  </h5></center>
      				...
      				<div>Do $dadosDoComprovante[1] - $dadosDoComprovante[4]
      					<table border='1' class='table' style='width: 100%;'>
							<
							<tr>
								<th colspan='2' class='th1'>Identidade COMAER:
								$dadosDoComprovante[6]</th>

								<th colspan='2' class='th1'>SARAM:
								$saram</th>
                                                                    
							</tr>
<tr>
								<th colspan='2' class='th1'>Email FAB:
								$email</th>

								<th colspan='2' class='th1'>Email Particular:
								$emailP</th>
...
<tr>
								<th class='th1'>Boletim e data da Apresentação</th>
								<th class='th2'>$apresentacao</th>
                                                                    <th class='th1'> Boletim e data da movimentação</th>
								<th class='th2'>$transferencia</th>
							</tr>
...
<div>
      					<table  border='1' class='table' style='width: 100%;'>
							...
							<? include('infor.php');?>
                               ...
                               2. Tal solicitação encontra amparo no ART. 52 parágrafo 1º do Regulamento dos Colégios Militares (R-69).
".
